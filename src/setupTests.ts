...
(globalThis as unknown as { localStorage: typeof localStorage }).localStorage = localStorageMock;
...
(globalThis as unknown as { sessionStorage: typeof sessionStorage }).sessionStorage = sessionStorageMock;
